...
export default function Chat() {
  ...
  const handleSendFile = useCallback(async (file, caption, onProgress, isSnap) => {
  ...
  const handleSend = useCallback(async ({ content, isSnap }) => {
    try {
      if (content?.trim()) {
        const optimistic = {
          id: `temp-${Date.now()}`,
